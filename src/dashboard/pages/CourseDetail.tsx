...
const CourseDetail: React.FC = () => {
  ...
  const chapters: Chapter[] = [
    { id: "ch1", title: "Introduction", duration: "10 min", videoUrl: "https://drive.google.com/file/d/17Ylf9SEA0JrdPNjH1S_mP6hDAUoK341y/view?usp=sharing", completed: true },
    { id: "ch2", title: "Basic Concepts", duration: "15 min", videoUrl: "https://example.com/video2", completed: true },
    { id: "ch3", title: "Advanced Techniques", duration: "20 min", videoUrl: "https://example.com/video3", completed: false },
    { id: "ch4", title: "Practical Applications", duration: "25 min", videoUrl: "https://example.com/video4", completed: false },
    { id: "ch5", title: "Final Project", duration: "30 min", videoUrl: "https://example.com/video5", completed: false },
  ];
          ...
          <Card className="p-6 bg-gray-900/50 border-gray-800 md:col-span-1">
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-100 text-sm mb-4">{course.description}</p>
              </div>
                    ...
                    <div className="flex items-center">
                      <div className={`w-6 h-6 rounded-full flex items-center justify-center mr-3 ${
                        ...
                        {chapter.completed ? (
                          ...
                          <span className="text-xs">{chapters.indexOf(chapter) + 1}</span>
                        )}
                      </div>
                      <div>
